...
int nAnonymizeMouseAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Mouse
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Mouse
    // Mac: ~/Library/Application Support/Mouse
    // Unix: ~/.Mouse
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mouse";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Mouse.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "moused.pid"));
