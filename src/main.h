...
#define START_MASTERNODE_PAYMENTS 1515513277 //24 Oct 2017 15:15:15 GMT

static const int64_t DARKSEND_COLLATERAL = (50*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 MOUSE per COIN
static const int64_t TARGET_SPACING = 2 * 60; // 1 min per Block
static const int64_t TARGET_SPACING2 = 2 * 60; // 1 min per Block
