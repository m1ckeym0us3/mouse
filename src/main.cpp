...
const string strMessageMagic = "Mouse Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    } else if (nHeight > 300 && nHeight <= 1500){
      nSubsidy = 3 * COIN;
    } else if (nHeight > 1500 && nHeight <= 2500){
      nSubsidy = 100 * COIN;
    } else if (nHeight > 2500 && nHeight <= 3500){
      nSubsidy = 50 * COIN;
    } else if (nHeight > 3500 && nHeight <= 4500){
      nSubsidy = 25 * COIN;
    } else if (nHeight > 4500 && nHeight <= 5500){
      nSubsidy = 10 * COIN;
    } else {
      nSubsidy = 5 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 1500 && nBestHeight <= 50000){
      nSubsidy = 35 * COIN;
    } else{
      nSubsidy = 3 * COIN;
    }
